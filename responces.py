...
def handle_response(message: str) -> str:
    ...
    if p_message == "clara":
        ...
        return 'team comps: https://genshinlab.com/honkai-star-rail-team/luocha-team-guide/\n\n'\
               'optimization: https://genshin.gg/star-rail/characters/luocha/'
    elif p_message == 'yukong':
        return 'team comps: https://genshinlab.com/honkaistarrail-characters/yukong-build/\n\n'\
               'optimization: https://genshin.gg/star-rail/characters/yukong/'
    elif p_message == 'data':
